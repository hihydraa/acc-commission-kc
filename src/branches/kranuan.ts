...
export const kranuanBranch: BranchConfig = {
  ...
  // ต่างจากสามทอง (ที่หักหนี้อัตโนมัติเต็มจำนวน ยืนยันจากตัวเลขอ้างอิง ฿180): ไฟล์
  // อ้างอิงที่อนุมัติของกระนวนเองระบุชัดในชีทหมายเหตุข้อ 5 ว่า "คำนวณเต็มจำนวนไปก่อน
  // แล้วทำเครื่องหมายเตือนบัญชี... ตั้งค่าเริ่มต้น = 0" — บัญชีเป็นคนตัดสินใจหัก 50%/100%
  // เองนอกระบบตาม policy ข้อ 6-7 ไม่ใช่สูตรอัตโนมัติ
  debtDeductionMode: "flagOnly",
